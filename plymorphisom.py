...
#Polymorphism
employees = [SofwareEngineer("Kolawole", 20, 5000000, "Junior"),
            SofwareEngineer("Ayodeji", 25, 23000000, "Senior"),
            Designer("Philipp", 27, 1200000)]
def motivate_employees(employees):
    for employee in employees:
        employee.worker()
print(motivate_employees(employees))